...
/*  Modify an IST so that he respects his mathematical definition. */
void ist_merge_sons(ISTNode *Source, ISTNode *Target) ;
void ist_adjust_first_condition(ISTSharingTree *S) ;
void ist_adjust_second_condition(ISTSharingTree *S) ;
void ist_normalize(ISTSharingTree *S) ;
