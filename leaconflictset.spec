...
Rwhile1 = 2 && Rretreiving = 0 && Rwhile2 = 0 && Rbeforewait = 0 && Rwait = 0 && Rafterwait = 0 && Rincretreiving = 0 && Rexitlock = 0 && Rdoretreiving = 0 && Rfinally = 0 && Rnotifyall = 0 && Rend = 0 && Swhile1 = 2 && Sstoring = 0 && Swhile2 = 0 && Sbeforewait = 0 && Swait = 0 && Safterwait = 0 && Sincstoring = 0 && Sexitlock = 0 && Sdostore = 0 && Sfinally = 0 && Snotifyall = 0 && Send = 0
