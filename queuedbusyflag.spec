...
Iwhile Igetbusyflag Ichoice1 Iif1 Ichoice2 Igoto1 Ichoice3 Iwhile2 Iwait Iafterwait Iafterwhile Ibeforeendget Iendget Iwork Iif2 Iif3 Ichoice4 Inotifyall Iassign Ichoice5 Iendfree
...
Iendget = 0 && Iwork = 0 && Iif2 = 0 && Iif3 = 0 && Ichoice4 = 0 && Inotifyall = 0 && Iassign = 0 && Ichoice5 = 0 && Iendfree = 0 &&
...
Jwork = 0 && Jif2 = 0 && Jif3 = 0 && Jchoice4 = 0 && Jnotifyall = 0 && Jassign = 0 && Jchoice5 = 0 && Jendfree = 0 &&
Owhile = 2 && Ogetbusyflag = 0 && Ochoice1 = 0 && Oif1 = 0  && Ochoice2 = 0 && Ogoto1 = 0 && Ochoice3 = 0 && Owhile2 = 0 && Owait = 0 && Oafterwait = 0 && Oafterwhile = 0 && Obeforeendget = 0 && Oendget = 0 && Owork = 0 &&
Oif2 = 0 && Oif3  = 0 && Ochoice4 = 0 && Onotifyall  = 0 && Oassign = 0 && Ochoice5 = 0 && Oendfree = 0 && error = 0
...
#Iwhile = 1, Igetbusyflag = 1, Ichoice1 = 1, Iif1 = 1, Ichoice2 = 1, Igoto1 = 1, Ichoice3 = 1, Iwhile2 = 1, Iwait = 1, Iafterwait = 1, Ibeforeendget = 1, Iendget = 1, Iwork = 1, Iif2 = 1, Iif3 = 1, Ichoice4 =1, Inotifyall = 1, Iassign = 1, Ichoice5 = 1, Iendfree = 1
#Jwhile = 1, Jgetbusyflag = 1, Jchoice1 = 1, Jif1 = 1, Jchoice2 = 1, Jgoto1 = 1, Jchoice3 = 1, Jwhile2 = 1, Jwait = 1, Jafterwait = 1, Jbeforeendget = 1, Jendget = 1, Jwork = 1, Jif2 = 1, Jif3 = 1, Jchoice4 =1, Jnotifyall = 1, Jassign = 1, Jchoice5 = 1, Jendfree = 1
#Ichoice1 = 1, Iif1 = 1, Ichoice2 = 1, Igoto1 = 1, Ichoice3 = 1, Iwhile2 = 1, Ibeforeendget = 1, Iendget = 1, Iif2 = 1, Iif3 = 1, Ichoice4 = 1, Inotifyall = 1, Iassign = 1, Ichoice5 = 1, Iendfree = 1, Jchoice1 = 1, Jif1 = 1, Jchoice2 = 1, Jgoto1 = 1, Jchoice3 = 1, Jwhile2 = 1, Jbeforeendget = 1, Jendget = 1, Jif2 = 1, Jif3 = 1, Jchoice4 = 1, Jnotifyall = 1, Jassign = 1, Jchoice5 = 1, Jendfree = 1, Ochoice1 = 1, Oif1 = 1, Ochoice2 = 1, Ogoto1 = 1, Ochoice3 = 1, Owhile2 = 1, Obeforeendget = 1, Oendget = 1, Oif2 = 1, Oif3 = 1, Ochoice4 = 1, Onotifyall = 1, Oassign = 1, Ochoice5 = 1, Oendfree = 1,
