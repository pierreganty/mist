 ...
 */
ISTSharingTree *ist_intersection_with_formula_transfer(ISTSharingTree *ST1,
		integer16 *PlacesInTransfer, ISTInterval *Value, integer16
		height);
ISTSharingTree *ist_pre_of_transfer(ISTSharingTree *S, transition_t *transition, integer16 nbr_variables);
ISTSharingTree *ist_pre_of_rule_plus_transfer(ISTSharingTree *Prec, transition_t *transition, integer16 nbr_variables);
